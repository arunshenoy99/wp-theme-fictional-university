...
class FeaturedProfessor {
  ...
  function onInit() {
    ...
    register_meta('post', 'featuredprofessor', array(
      'show_in_rest' => true,
      'type' => 'number',
      // Single false here indicates that whenever you recieve an array of numbers then do not store it as a serialzed array which can reduce performance.
      // Rather store each of the item in an array as a new entry
      'single' => false
    ));
