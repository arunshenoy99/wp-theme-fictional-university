...
class Like {
  ...
  ourClickDispatcher(e) {
    var currentLikeBox = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).closest('.like-box'); // The jquery data method only checks for data attributes that were loaded the first time a page rendered.
...
class MyNotes {
  ...
  createNote(e) {
    var ourNewPost = {
      ...
      // We can set this status to private in order to achieve privacy for user notes.
      // This method is not secure since client side js can always be modified and hence we 
      // should not be relying on setting status as private here as a way to create private posts.
      'status': 'publish'
    };
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      beforeSend: xhr => {
      ...
      success: response => {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(`
                <li data-id="${response.id}">
                    ...
                    <textarea class="note-body-field" readonly>${response.title.raw}</textarea>
